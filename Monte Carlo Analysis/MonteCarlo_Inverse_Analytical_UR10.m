...
r2s = csvread('Robot2Sensor_UR10.csv');

data = csvread('Data_UR10_0250.csv');
...
q1_RMSE = 0.259000000000000; %Root mean squared error from inverse evaluation (degrees)
numSim = 2; %Number of simulations for each MC

%Factory Calibrated Correction Factor
delta_a = [2.029e-5,0.0027186,0.001886,-0.0003878,0.00044339,0]; %meters?
delta_d = [0.0006678,8.515,-10.9225,2.40718,-8.171e-5,0.00018177];%meters?
delta_p = [-0.00035558, -0.00727,-0.01237,-0.00093892,0.00036905,0]; %radians?

%Dh parameters
d0 = 0;     d1 = 0.1273*1000+delta_d(1);   d2 = 0+delta_d(2);               d3 = 0+delta_d(3);             d4 = 0.163941*1000+delta_d(4);     d5 = 0.1157*1000+delta_d(5);   d6 = 0.0922*1000+delta_d(6);% d (unit: mm)
a0 = 0;     a1 = 0+delta_a(1);             a2 = -0.612*1000+delta_a(2);     a3 = -0.5723*1000+delta_a(3);  a4 = 0+delta_a(4);                 a5 = 0+delta_a(5);             a6 = 0+delta_a(6);% a (unit: mm)
